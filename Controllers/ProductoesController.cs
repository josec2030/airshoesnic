...
namespace AirShoesNic01.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public ProductoesController(AirShoesNic01Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Producto != null ? 
                          ...
                          Problem("Entity set 'AirShoesNic01Context.Producto'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AirShoesNic01Context.Producto'  is null.");
            }
            var producto = await _context.Producto.FindAsync(id);
            if (producto != null)
            {
